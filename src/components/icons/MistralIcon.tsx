...
export function MistralIcon({ className = '', size = 24, style }: MistralIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <g transform="translate(6 79.299) scale(1.96335)">
        <clipPath id="mistral-sm-a">
          <path d="M0 0h254.667v180H0z"/>
        </clipPath>
        <g clipPath="url(#mistral-sm-a)">
          <g transform="scale(1.33333)">
            <clipPath id="mistral-sm-b">
              <path d="M0 0h190.141v135H0z"/>
            </clipPath>
            <g clipPath="url(#mistral-sm-b)" fillRule="nonzero">
